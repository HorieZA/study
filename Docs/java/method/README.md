...
### 메소드 구조
<img src="../../images/java/Method_1.png" width="600" ></img>

### 리턴타입이 필요없을 경우 (void) 
<img src="../../images/java/Method_2.png" width="600" ></img>

### 리턴타입이 필요한 경우 (자료형)
<img src="../../images/java/Method_3.png" width="600" ></img>

### 매개변수가 필요한 경우 (변수 선언)
<img src="../../images/java/Method_4.png" width="600" ></img>
