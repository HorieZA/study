      ...
      <form onSubmit={onSubmit}>
        <div className="mb-3 mt-3">
          ...
          <input type="text" className="form-control" id="name" placeholder="이름을 입력하세요."
            name="name" readOnly="readonly" value={name} onChange={e => setName(e.target.value)} />
        </div>
        <div className="mb-3 mt-3">
          ...
          <div className="p-2 flex-fill">
            <div className="form-check">
              <input type="radio" className="form-check-input" id="radio1"
                name="gender" value="1" checked={gender} onChange={e => setGender(true)} />남성
          ...
          <div className="p-2 flex-fill">
            <div className="form-check">
              <input type="radio" className="form-check-input" id="radio2"
                name="gender" value="2" checked={!gender} onChange={e => setGender(false)} />여성
