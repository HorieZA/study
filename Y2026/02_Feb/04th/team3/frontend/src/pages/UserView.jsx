...
const UserView = () => {
  ...
  const submitE = e => {
    e.preventDefault()
    const params = { userNo, name, email, pwd, gender, regDate, modDate, proNo, origin, fileName }
    console.log(params)
  ...
  return (
    <div class="container mt-3 position-relative">
      <h1 class="display-1 text-center">회원정보</h1>
      <div>
      {
        fileName ? ( 
          <img src={`../${fileName}`} className="border user_pt" alt={origin} />
        ) : (
          <img src="../img01.jpg" className="border user_pt" alt="default" />
        )
      }
      </div>
