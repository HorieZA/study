...
# trs[i].select("td")[4] # 곡명을 가져와라
# .select_one("div[class='ellipsis rank01']").text # div[class='ellipsis rank01']의 텍스트만 가져와라
# .replace("\n", "") # "\n"(줄바꿈 표시를)  텍스트에서 빈값으로 변경해라
# .replace("\xa0", " ") #"\xa0"(스페이스바를) " "(띄움표시로) 변경해라
