...
const App = () => {
  ...
  const event1 = e => {
    ...
    axios.post("http://t3s3.quadecologics.cloud:6303/login", {"email": e.target.email.value})
    .then(res => {
      console.log(res)
      if(res.data.status) {
  ...
  const event2 = e => {
    ...
    axios.post("http://t3s3.quadecologics.cloud:6303/code", {"id": e.target.code.value})
    .then(res => {
      console.log(res)
      if(res.data.status) {
  ...
  const event3 = e => {
    ...
    axios.post("http://t3s3.quadecologics.cloud:6303/me", {}, 
